...
(async () => {
  ...
  await fs.writeFile("cardiac-arrythmia-elixhauser-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("cardiac-arrythmia-elixhauser-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
